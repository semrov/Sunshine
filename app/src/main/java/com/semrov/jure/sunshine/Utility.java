...
public class Utility
{
    ...
    public static final String DATE_FORMAT = "ddMMyyyy"; //"yyyyMMdd";
    ...
    public static String formatTemperature(Context c, double temperature, boolean isMetric) {
        double temp;
        if ( !isMetric ) {
        ...
        return c.getString(R.string.format_temperature, temp) + (!isMetric ? "C" : "F");
    }
